...
(function() {
  var React, Rebass, Teact, blessedTags, elements, fn, fn1, fn2, funct, i, j, key, len, len1, merge_elements, ref, ref1, singleton, tagName,
    slice = [].slice,
  ...
  Teact = (function() {
    ...
    Teact.prototype.bless = function(reactComponent, itsName) {
      var name;
      if (itsName == null) {
        itsName = null;
      }
      if (reactComponent.__esModule && reactComponent["default"]) {
      ...
      return Teact.prototype[name] = (function(_this) {
        return function() {
          var args;
          args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
          return _this.crel.apply(_this, [reactComponent].concat(slice.call(args)));
        };
      })(this);
    };
