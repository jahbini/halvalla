...
(function() {
  ...
  module.exports = Teacup = Teacup = (function() {
    ...
    Teacup.prototype.march = function(bag) {
      var component, n, results, tagName;
      results = [];
      while (component = bag.inspect()) {
        switch (n = component.constructor.name) {
          case 'Function':
            results.push(this.bag.reinspect(this.instantiator(component)));
            break;
          case 'String':
          case 'Number':
            results.push(this.bag.shipOut(component.toString()));
            break;
          case 'Array':
          ...
          default:
            ...
            results.push(bag.shipOut(this[tagName](component)));
        }
      }
      return results;
    };
