...
(function() {
  var BagMan, Teacup, allTags, doctypes, elements, escape, fn1, fn2, fn3, fn4, fn5, fn6, i, j, l, len, len1, len2, len3, len4, len5, m, mergeElements, normalizeArray, o, p, quote, ref, ref1, ref2, ref3, ref4, ref5, ref6, tagName,
    slice = [].slice,
  ...
  module.exports = Teacup = Teacup = (function() {
    ...
    Teacup.prototype.march = function(bag) {
      var attrs, component, n, node, ref1, tagConstructor, tagName, y;
      while (component = bag.inspect()) {
        console.log("March Teacup", ((ref1 = component._Halvalla) != null ? ref1.birthName : void 0) || component.toString());
        switch (n = component.constructor.name) {
          ...
          case 'Array':
            ...
            break;
          default:
            if (!component._Halvalla) {
              throw new Error("unclean component", component);
            }
    ...
    Teacup.prototype.tag = function(cell) {
      var children, props, ref1, result, tagName, x;
      ...
      } else if ((ref1 = cell.tag) != null ? ref1.view : void 0) {
        debugger;
        x = cell.tag.view();
        result += this.render(x);
      } else {
        result += this.render(children);
      }
      if (tagName !== 'text') {
        result += "</" + tagName + ">";
      }
    ...
    Teacup.prototype.scriptTag = function(cell) {
      ...
      tagName = this.oracle.getName(cell);
      result = "<" + tagName + (this.renderAttrs(props)) + ">";
      result += this.renderContents(children);
      result += "</" + tagName + ">";
      return result;
    };
