...
(function() {
  ...
  Halvalla = (function() {
    ...
    Halvalla.prototype.crel = function() {
      var args, attrs, children, contents, el, previous, ref1, ref2, stackHad, tagName;
      tagName = arguments[0], args = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      if (tagName == null) {
    ...
    Halvalla.prototype.render = function() {
      var badDog, node, previous, rest, result, structure;
      ...
      switch (typeof structure) {
        case 'string':
        case 'number':
          structure = this.crel('text', '', structure);
      }
